  ...
  return (
    <>
        <div className='d-flex align-items-center'>
            ...
            <button onClick={handleShow} className='btn'><i className="fa-solid fa-cloud-arrow-up fs-5"></i></button>
        </div>
        <Modal
        show={show}
        onHide={handleClose}
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title> <i className="fa-solid fa-film me-2 text-warning"></i>Upload Videos</Modal.Title>
        </Modal.Header>
        <Modal.Body>
...
//https://www.youtube.com/watch?v=yci475Vwc10

//https://www.youtube.com/embed/yci475Vwc10