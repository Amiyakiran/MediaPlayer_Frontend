    ...
    <>
      <Row className='mt-5 mb-5 d-flex justify-content-evenly align-items-center w-100'>
        ...
        <Col lg={5}>
          ...
          <p style={{textAlign:'justify'}} className='mt-4'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Consequuntur repellendus, ratione ipsum laudantium iste aperiam cupiditate maxime nisi perspiciatis distinctio sint unde, aliquam numquam voluptates quasi, molestiae voluptatem facilis. Iusto? Lorem ipsum dolor sit amet consectetur, adipisicing elit. Temporibus, necessitatibus quaerat doloribus eum totam velit minima deleniti asperiores. Veritatis iure ex veniam aut numquam a neque mollitia tempore accusantium corporis!</p>
          <button onClick={()=>navigateByUrl('/home')} className='btn btn-warning mt-5'>Get Started <i className="fa-solid fa-arrow-right ms-2"></i></button>
        </Col>
        <Col></Col>
        <Col lg={5}>
      ...
      <div className="container border border-2 border-secondary rounded w-100 p-5 mt-5 mb-5 d-flex align-items-center justify-content-between">
        <Row>
          <Col lg={5}>
            ...
            <h6 className='mb-3'><span className='fw-bolder fs-5'>Play Everything</span> : Amet consectetur adipisicing elit. Autem veritatis totam tempore expedita! Quae quam, commodi dolorum iste unde atque alias debitis voluptates nesciunt</h6>
            <h6 className='mb-3'><span  className='fw-bolder fs-5'>Play Everything</span> : Amet consectetur adipisicing elit. Autem veritatis totam tempore expedita! Quae quam, commodi dolorum iste unde atque alias debitis voluptates nesciunt</h6>
            <h6 className='mb-3'><span  className='fw-bolder fs-5'>Play Everything </span>: Amet consectetur adipisicing elit. Autem veritatis totam tempore expedita! Quae quam, commodi dolorum iste unde atque alias debitis voluptates nesciunt</h6>
          </Col>
          <Col></Col>
